...
<div class="book-detail">
	...
	<?php endif; ?>
	<a href="<?php echo $baseUrl; ?>/profile/<?php echo $book->getUserId(); ?>" class="btn btn-primary">Voir le profil du propriétaire</a>
	<?php if (isset($_SESSION['user']) && $_SESSION['user']['id'] !== $book->getUserId()): ?>
		<a href="<?= $baseUrl ?>/conversation/start/<?= $book->getUserId() ?>" class="btn btn-outline">Envoyer un message</a>
	<?php endif; ?>
</div>
